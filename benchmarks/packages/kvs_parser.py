...
class KVSParser(Parser):
    ...
    def _add_kvs_arguments(self):
        self.parser.add_argument('--operation_size', type=str, required=True, help='Operation sizes for KVS benchmarks')
        self.parser.add_argument('--operation_type', type=str, required=True, help='Operation types for KVS benchmarks')
