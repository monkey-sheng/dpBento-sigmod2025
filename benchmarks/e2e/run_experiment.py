...
def run_benchmark_test(scale_factors, query_numbers, execution_modes, output_folder, log_file):
    results = []
    parquet_base_dir = Path('/tmp/fio_test')
            ...
            for query_num in query_numbers:
                ...
                for execution_mode in execution_modes:
                    if execution_mode == "cold":
                        conn.execute("PRAGMA drop_cache();")
                        ...
                        results.append({
                            ...
                            'Query': query_name,
                            'Execution Mode': execution_mode,
                            'Average Run Time (s)': average_run_time
                        })
    ...
    results_df.loc[len(results_df)] = [None, None, 'avgruntime', avg_runtime_all_queries]
